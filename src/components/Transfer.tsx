...
const Transfer: React.FC<TransferProps> = ({ transfer }) => {
  ...
  const acceptTransfer = useCallback(
    () => dispatch(acceptTransferAction(transfer.callId)),
    [transfer, dispatch]
  );
  const rejectTransfer = useCallback(
    () => dispatch(rejectTransferAction(transfer.callId)),
    [transfer, dispatch]
  );
  const cancelTransfer = useCallback(
    () => dispatch(cancelTransferAction(transfer.callId)),
    [transfer, dispatch]
  );
  const dismissTransfer = useCallback(
    () => dispatch(removeTransferAction(transfer.callId)),
    [transfer, dispatch]
  );
